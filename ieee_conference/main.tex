...
\author{\IEEEauthorblockN{1\textsuperscript{st} Luca Uckermann\orcidlink{0009-0005-2957-6331}}
    \IEEEauthorblockA{\textit{Institute of Media and Imaging Technology} \\
        \textit{TH Köln - University of Applied Sciences}\\
        Cologne, Germany\\
        luca\_simon.uckermann@th-koeln.de}
    \iffalse
        \and
...
%\bibliography{resources/bib/IEEEabrv,resources/bib/references}
